CLASS zcl_rap100_gen_data_as DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_AS IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '_AS',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav_as.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zrap100_atrav_as  FROM (
        SELECT
