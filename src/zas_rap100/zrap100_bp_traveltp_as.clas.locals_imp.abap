...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_AS,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atrav_as FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtrav_as FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
...
**************************************************************************
  METHOD get_instance_features.
    ...
    READ ENTITIES OF ZRAP100_R_TravelTP_AS IN LOCAL MODE
      ENTITY travel
  ...
  METHOD setStatusToOpen.
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_AS IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
  METHOD deductDiscount.
    DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_AS.
...
**************************************************************************
  METHOD copyTravel.
    DATA:
       travels       TYPE TABLE FOR CREATE ZRAP100_R_TravelTP_AS\\travel.
